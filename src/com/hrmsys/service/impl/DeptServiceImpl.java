...
public class DeptServiceImpl implements DeptService {
	...
	public String getReportDate() {
		...
		deptXML += "<?xml version='1.0' encoding='UTF-8'?><chart caption='门店人数统计'"
				+ " xAxisName='门店' yAxisName='人数' bgColor='#e3f6df;' showValues='1'  "
				+ "canvasBgColor='#e3f6df;' baseFontSize='13' decimals='0' animation='1' "
